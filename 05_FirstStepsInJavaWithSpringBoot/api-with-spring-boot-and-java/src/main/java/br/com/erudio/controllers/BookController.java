...
public class BookController {
	...
	@Operation(summary = "Adds a new Book", description = "Adds a new Book by passing in a JSON, XML or representation of the Book!", 
		tags = {"Book"}, 
		responses = {
			@ApiResponse(description = "Success", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = BookVO.class))
	...
	@Operation(summary = "Updates a Book", description = "Updates a Book by passing in a JSON, XML or representation of the Book!", 
		tags = {"Book"}, 
		responses = {
	...
	@Operation(summary = "Deletes a Book", description = "Deletes a Book by passing in a JSON, XML or representation of the Book!", 
		tags = {"Book"}, 
		responses = {
			@ApiResponse(description = "No content", responseCode = "204", content = @Content),
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
